...
from teamux.auth_helper import get_sign_in_flow, get_token_from_code, store_user, remove_user_and_token, get_token
from teamux.graph_helper import *

# <HomeViewSnippet>
def home(request):
  context = initialize_context(request)

  return render(request, 'teamux/home.html', context)
# </HomeViewSnippet>
...
def calendar(request):
  ...
  return render(request, 'teamux/calendar.html', context)
# </CalendarViewSnippet>
...
def newevent(request):
  ...
  if request.method == 'POST':
    ...
    if (not request.POST['ev-subject']) or \
      ...
      return render(request, 'teamux/newevent.html', context)
